...
func (p *hbaseProcessorAppend) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := AppendArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
func (p *hbaseProcessorCheckAndPut) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CheckAndPutArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
func (p *GetColumnDescriptorsResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _val99.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _val99, err)
		}
...
func (p *GetResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem104.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem104, err)
		}
...
func (p *GetVerResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem107.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem107, err)
		}
...
func (p *GetVerTsResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem110.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem110, err)
		}
...
func (p *GetRowWithColumnsResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem117.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem117, err)
		}
...
func (p *GetRowsResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem128.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem128, err)
		}
...
func (p *IncrementRowsArgs) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem161.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem161, err)
		}
...
func (p *ScannerGetResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem181.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem181, err)
		}
